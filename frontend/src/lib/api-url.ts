 ...
 * Vercel env noto'g'ri nusxalansa ham (masalan Desktop yo'li bilan)
 * ichidan to'g'ri https://... manzilni ajratib oladi.
 */
...
export const PUBLIC_API_URL = normalizeApiBaseUrl(
